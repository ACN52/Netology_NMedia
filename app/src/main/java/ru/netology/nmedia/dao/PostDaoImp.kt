...
//        const val COLUMN_LOOKS = "looksCount"
...
//            put(PostColumns.COLUMN_SHARES, post.sharesCount)
//            put(PostColumns.COLUMN_LOOKS, post.looksCount)
...
//        db.execSQL(
//            "UPDATE posts SET sharesCount = sharesCount + 1 WHERE id = ?",
//            arrayOf(id)
//        )
//    }
//
...
//        db.execSQL(
//            "UPDATE posts SET looksCount = looksCount + 1 WHERE id = ?",
//            arrayOf(id)
//        )
//    }
//
...
//                looksCount = getInt(getColumnIndexOrThrow(PostColumns.COLUMN_LOOKS)),
